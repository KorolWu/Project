package com.cowain.utils;

import com.cowain.entity.ColumnEntity;
import com.cowain.entity.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.cowain" : mainPath;
        String subModuleName  = StringUtils.isBlank(config.getString("subModuleName" )) ? "" : config.getString("subModuleName" );
        //封装模板数据
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(template, tableEntity.getClassName(), config.getString("package" ), config.getString("moduleName" ),config.getString("subModuleName" ))));
     ...
     * 获取文件名
     */
    public static String getFileName(String template, String className, String packageName, String moduleName,String subModuleName) {
        String packagePath = "main" + File.separator + "java" + File.separator;
        if (StringUtils.isNotBlank(packageName)) {
            packagePath += packageName.replace(".", File.separator) + File.separator + moduleName + File.separator;
        }
        if (StringUtils.isNotBlank(subModuleName)) {
            packagePath += subModuleName + File.separator;
        }
